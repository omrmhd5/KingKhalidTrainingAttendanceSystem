...
export function ExportExcel({ data }: ExportExcelProps) {
  const generateExcel = async () => {
    ...
    titleCell.fill = solid("FF1A56DB");
    titleCell.alignment = { horizontal: "center", vertical: "middle" };
    titleCell.border = thinBorder("FF1A56DB");
    ...
    headerRow.eachCell((cell, colNumber) => {
      ...
      if (colNumber >= 6) {
        ...
        cell.fill = solid("FF2563EB");
        cell.alignment = { horizontal: "center", vertical: "middle" };
        cell.border = thinBorder("FF1D4ED8");
      }
    });
    ...
    data.forEach((t: any, i: number) => {
      ...
      const fgArgb = isEven ? "FFEFF6FF" : "FFFFFFFF";
    ...
    totalCell.font = { bold: true, size: 13, color: { argb: "FF1E40AF" } };
    totalCell.fill = solid("FFDBEAFE");
    totalCell.alignment = { horizontal: "center", vertical: "middle" };
    totalCell.border = thinBorder("FF93C5FD");
